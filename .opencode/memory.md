...
6. Never use px as a unit for anything. Use % so that it's proportional to its parent element. You must use rem for font-sizes. Except for the following in which you are allowed to use px: border-radius.
