...
const products = [
  ...
  },
  {
    ...
    description:
      "productivity brings your work life into dvibd — notes, cloud storage, email, and document editing as separate apps that share one connected workspace. Draft a note, attach a file from the cloud, and send it by email without leaving dvibd.",
    features: [
        ...
        {products.map((product) => (
          ...
          >
            <div class={styles.itemHead}>
              <span class={styles.chip}>{product.title}</span>
              {product.status === "soon" && (
